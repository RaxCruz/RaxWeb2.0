            ...
            <div className="container mx-auto">
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        ...
                        <span className="text-primary mb-2 block text-lg font-semibold font-['LolTitleItalic']">
                            What I offer
                        </span>
                        <h2
                            className="mb-4 text-[6rem]  sm:text-[7rem] md:text-[8rem]  md:leading-[1.5]"
                            >
                            豐富資源
                        </h2>
                        <p className="text-body-color text-base dark:text-dark-6 font-['LolTitleItalic']">
                            完全免費的額外學習資源，讓你盡情的享受在編程的快樂當中！
                        </p>
                        </div>
                    </div>
                </div>
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div
                        className="mb-9 hover:bg-stripe hover:animate-stripe-slow hover:bg-[length:7px_7px] rounded-[20px] border-black border-2 border-r-4 border-b-4 border-blackrounded-[20px] p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10"
                        >
                        <div
                        ...
                        <h4 className="text-dark dark:text-white mb-[14px] text-4xl font-['ChenYu']">
                            技能樹規劃
                        </h4>
                        <p className="text-gray-400 font-['LolTitleItalic'] text-md">
                            客製化獨立的技能樹，全局視野清楚訂定學習方向
                    ...
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div
                        className="mb-9 hover:bg-stripe hover:animate-stripe-slow hover:bg-[length:7px_7px] rounded-[20px] border-black border-2 border-r-4 border-b-4 border-black p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10"
                        >
                        <div
                            className="bg-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl"
                            >
                        ...
                        <p className="text-gray-400 font-['LolTitleItalic'] text-md">
                            自身經驗編寫的教材，告訴你高階工程師不告訴你的撇步
                        </p>
                        </div>
                    </div>
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div
                        className="mb-9 hover:bg-stripe hover:animate-stripe-slow hover:bg-[length:7px_7px] border-2 border-black border-r-4 border-b-4 rounded-[20px]   p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10"
                        >
                        <div
                            className="bg-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl"
                            >
                    ...
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        ...
                        <p className="text-gray-400 font-['LolTitleItalic'] text-md">
                            即時的線上評測，隨時可檢測自己的程式實力外，增加程式題目的理解能力
                        </p>
                        </div>
                    </div>
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div
                        className="mb-9 hover:bg-stripe hover:animate-stripe-slow hover:bg-[length:7px_7px] border-2 border-r-4 border-b-4 rounded-[20px] border-black ounded-[20px]   p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10"
                        >
                        <div
                            className="bg-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl"
                            >
                        ...
                        <p className="text-gray-400 font-['LolTitleItalic'] text-md">
                            免費借閱實體書籍，包括電腦領域，原文書籍，基礎應用知識領域相關
                        </p>
                        </div>
                    </div>
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div
                        className="mb-9 hover:bg-stripe hover:animate-stripe-slow hover:bg-[length:7px_7px] border-2 border-r-4 border-b-4 border-black rounded-[20px]   p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10"
                        >
                        <div
                            className="bg-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl"
                            >
